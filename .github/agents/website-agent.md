...
- Static and content-driven sites: Quarto, Bootstraps, Hugo, Jekyll, Astro, Next.js (content layer)
...
- Familiar with user's repositories: CVR_BAR, endophyte_leaf_traits, endophytes_mimulus_genotype, endophytes_mimulus, BRCore, lightSABR, mxg_genotype_exudates
